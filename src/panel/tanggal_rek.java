 ...
 * @author Nikx
 */
public class tanggal_rek extends javax.swing.JFrame {
    ...
    private void rSButtonRiple1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple1ActionPerformed
        try{
                String namaFile = "src/laporan/lap_rek_1.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tanggal_rek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tanggal_rek().setVisible(true);
            }
        });
    }
